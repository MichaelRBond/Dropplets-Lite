    ...
    <div class="row">
        ...
        <div class="three-quarters post">
            ...
            <ul class="actions">
                ...
                <li><a class="button" href="https://twitter.com/intent/tweet?text=&quot;<?php echo($page_title); ?>&quot;%20<?php echo($post_link); ?>%20via%20&#64;<?php echo($post_author_twitter); ?>" data-dnt="true">Share on Twitter</a></li>
